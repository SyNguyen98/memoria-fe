...
export default function HomeComponent() {
    ...
    return (
        <section className="home-container">
            {isTableOrPhone() ? (
                <Fragment>
                    <img className="sorry-img" src={`${Url.IMAGE}/scaracat-sad.webp`} alt="cry-icon"/>
                    <Typography className="sorry-text" variant="body1">
                        Sorry we did not support this screen yet.
                    </Typography>
                </Fragment>
            ) : (
                <Fragment>
                    ...
                    <div className="introduction">
                        ...
                        <Grid container className="introduce-content">
                            ...
                            <Grid item xs={7} className="introduce-text">
                                ...
                                về bạn
                                bè, gia đình. Những nơi bạn đã đi qua, những kỷ niệm bạn đã cùng trải qua cùng với những
                                người
                                thân thương, MEMORIA sẽ giúp bạn ghi dấu lại tất cả. MEMORIA vẫn sẽ ở đó, nhắc lại cho
                                bạn những
                    ...
                    <Grid className="feature-list" container rowSpacing={10}>
                        ...
                        <Grid item xs={6} className="text-wrapper">
                            ...
                            <Typography variant="body1">
                                ...
                                những câu
                                chuyện mà bạn đã trải qua. Để rồi khi nhìn lại, bạn sẽ bật cười nhớ về nó. MEMORIA ở đây
                                là để
                        ...
                        <Grid item xs={6} className="text-wrapper">
                            ...
                            <Typography variant="body1">
                                ...
                                tạo
                                nênnhững tấm ảnh tràn ngập kỷ niệm thì thật hạnh phúc biết bao. Để mai này nếu chẳng còn
                                sát
                                cánhbên nhau, ta có thể ngắm lại và hồi tưởng về những khoảnh khắc đó.
                            </Typography>
                        </Grid>
                        <Grid item xs={6} className="img-wrapper">
                            <img className="float-right" src={`${Url.IMAGE}/album.svg`} alt="album" width={400}
                                 height={400}/>
                        </Grid>
                        {/* Row 3 */}
                        <Grid item xs={6}>
                        ...
                        <Grid item xs={6} className="text-wrapper">
                            ...
                            <Typography variant="body1">
                                ...
                                ở
                                đâu. Với tính năng ghim địa điểm, bạn có thể ngắm lại những lần cùng nhau du lịch cùng
                                bạn bè
                                hoặcngười thân. Bất cứ nơi nào bạn đặt chân qua và muốn lưu lại những kỷ niệm, MEMORIA
                                đều sẽ
                                giúp bạn.
                            </Typography>
                        </Grid>
